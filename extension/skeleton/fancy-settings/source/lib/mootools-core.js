...
(function() {
  ...
  ["Object", "WhiteSpace", "TextNode", "Collection", "Arguments"].each(function(
    name
  ) {
    new Type(name);
  });
  ...
  function parser(
    ...
    if (combinator || combinatorChildren || combinatorIndex === -1) {
      ...
      if (reversed && currentSeparator[combinatorIndex])
        currentSeparator[combinatorIndex].reverseCombinator = reverseCombinator(
          combinator
        );
...
(function() {
  ...
  local.setDocument = function(document) {
    ...
    if (features.isHTMLDocument) {
      ...
      if (testNode.querySelectorAll) {
        ...
        try {
          ...
          features.brokenMixedCaseQSA = !testNode.querySelectorAll(".MiX")
            .length;
        } catch (e) {}
    ...
    features.contains =
      root && this.isNativeCode(root.contains)
  ...
  local.search = function(context, expression, append, first) {
    ...
    this.posNTHLast = {};
    this.posNTHType = {};
    this.posNTHTypeLast = {}; /*</pseudo-selectors>*/
  ...
  /*<pseudo-selectors>*/ local.cacheNTH = {};
  ...
  /*</nth-pseudo-selectors>*/ local.pushArray = function(
    node,
    tag,
    id,
    classes,
...
(function() {
  ...
  Document.implement({
    newElement: function(tag, props) {
      ...
      /*<ltIE8>*/ if (createElementAcceptsHTML && props) {
        tag = "<" + tag;
  ...
  Element.implement({
    ...
    getProperty: function(attribute) {
      ...
      return key
        ...
        : bools[attribute]
          ? !!this[attribute]
          : (uriAttrs.test(attribute)
              ? this.getAttribute(attribute, 2)
              : (key = this.getAttributeNode(attribute))
                ? key.nodeValue
                : null) || null;
    },
...
(function() {
  ...
  var setOpacity = function(element, opacity) {
    ...
    if (hasOpacity) {
      ...
      element.style.filter = reAlpha.test(filter)
  ...
  Element.Properties.opacity = {
    ...
    get: hasOpacity
      ...
      : function() {
          var opacity,
            filter = this.style.filter || this.getComputedStyle("filter");
